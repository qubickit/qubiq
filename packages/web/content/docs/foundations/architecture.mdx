...
`@nexakit/core` is organized into three collaborative layers. Each aligns with a portion of `/qubic/core` so TypeScript apps stay in sync with upstream releases.
...
- **Docs + `@nexakit/web`** surface guides, components, and contract playgrounds powered by this stack.
