...
description: Install @qubickit/core, bootstrap wallets, and run automation in minutes.
---

`@qubickit/core` mirrors the native Qubic node lifecycle in TypeScript. Follow this quickstart to derive a wallet, sign a transaction, and boot the automation runtime. Jump to deeper topics via the "Next steps" list below.
