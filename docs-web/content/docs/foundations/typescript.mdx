...
description: How to run @qubickit/core locally, explore examples, and extend the toolkit.
---
...
Use the same commands inside `docs-web/` to work on the documentation site:
...
1. Start the docs site (`bun dev` in `docs-web/`).
