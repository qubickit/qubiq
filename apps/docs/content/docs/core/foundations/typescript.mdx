...
This project is designed to feel great in everyday workflows—Bun for scripts/tests, Fumadocs for docs, and a set of runnable examples that mirror the guides on [core.qubiq.dev](https://core.qubiq.dev).
...
That’s it—the rest of the docs dive into modules like wallets, automation, interop, and monitoring, all available at [core.qubiq.dev](https://core.qubiq.dev).
