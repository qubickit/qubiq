...
The `proto/qubic/live_service.proto` file consolidates HTTP, stats, query-service, and archive endpoints. Once public gRPC access is available you can generate stubs from it; for now, the HTTP clients provide the supported surface. See [/core/interop](/core/interop) for usage.
